...
This agent generates comprehensive abstract test scenarios in natural language 
based on a code analysis report.
"""
...
def create_test_case_designer_agent() -> LlmAgent:
    """Creates and returns a configured Test Case Designer agent."""
    return LlmAgent(
